...
| [**T01**](#temas-específicos-tm) | **E03** | Gestão de Produtos                                | Permitir o gerenciamento completo do catálogo de produtos da barbearia, desde o cadastro até edição e inativação.                                     |
...
| **US06** | Como administrador, eu quero cadastrar novos produtos com nome, descrição, preço e status de disponibilidade para que eles fiquem disponíveis para venda e gestão no sistema. | [**T01**](#temas-específicos-tm) | [**E03**](#épicos-e) |
| **US07** | Como administrador, eu quero editar as informações de produtos cadastrados, como nome, valor e descrição para que eu possa manter os dados atualizados conforme mudanças no estoque ou estratégia de vendas. | [**T01**](#temas-específicos-tm) | [**E03**](#épicos-e) |
| **US08** | Como administrador, eu quero remover produtos do sistema com a opção de inativá-los para que eu possa manter o histórico de vendas sem exibir itens indisponíveis para venda. | [**T01**](#temas-específicos-tm) | [**E03**](#épicos-e) |
| **US09** | Como administrador, eu quero cadastrar novos serviços com nome, preço, duração estimada e profissionais habilitados para que eu possa oferecer e gerenciar os serviços disponíveis na barbearia. | [**T01**](#temas-específicos-tm) | [**E04**](#épicos-e) |
| **US10** | Como administrador, eu quero editar os dados dos serviços cadastrados, como preço, duração e barbeiros associados para que eu possa manter as informações sempre atualizadas e condizentes com a realidade da barbearia. | [**T01**](#temas-específicos-tm) | [**E04**](#épicos-e) |
| **US11** | Como administrador, eu quero remover serviços do sistema com a opção de arquivá-los para que eu possa manter o histórico de atendimentos e relatórios mesmo após descontinuar um serviço. | [**T01**](#temas-específicos-tm) | [**E04**](#épicos-e) |
